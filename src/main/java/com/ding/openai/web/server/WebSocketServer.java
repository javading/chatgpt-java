package com.ding.openai.web.server;

import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.ding.openai.entity.chat.Message;
import com.ding.openai.listener.WebSocketEventSourceListener;
import com.ding.openai.plugins.openai.chatgpt.ChatGPTStream;
import com.ding.openai.web.cache.LocalCache;
...
public class WebSocketServer {
    ...
    @Autowired
    public void setOrderService(ChatGPTStream chatGPTStream) {
    ...
    public void onMessage(String msg) {
        ...
        //接受参数
        WebSocketEventSourceListener eventSourceListener = new WebSocketEventSourceListener(this.session);
        ...
        if (StrUtil.isNotBlank(messageContext)) {
            ...
            Message currentMessage = Message.builder().content(msg).role(Message.Role.USER.getValue()).build();
