...
import com.ding.openai.exception.ChatException;
import com.ding.openai.entity.BaseResponse;
...
public class ChatGPT {
    ...
    public ChatGPT init() {
        ...
        client.addInterceptor(chain -> {
            ...
            Request request = original.newBuilder().header(Header.AUTHORIZATION.getValue(), "Bearer " + key)
        ...
        this.apiClient = new Retrofit.Builder().baseUrl(this.apiHost).client(okHttpClient)
                .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
                .addConverterFactory(JacksonConverterFactory.create()).build().create(Api.class);
